...
export default function Header() {
  return (
    <header className="px-7 h-[100px] flex items-center justify-between w-full bg-white fixed top-0">
      ...
      <nav className="flex items-center justify-between w-[440px]">
        ...
        <Link
          href="/company"
        >
          <span className={`${roboto.className} text-center text-xl font-bold text-[#292f36] md:text-left mt-5 md:pl-8`}>Company</span>
        </Link>
        <Link
          href="/blog"
        >
